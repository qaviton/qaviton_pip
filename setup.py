package_name = "qaviton_pip"


if __name__ == "__main__":
    from sys import version_info as v
    from qaviton_pip import __author__, __version__, __author_email__, __description__, __url__, __license__
    ...
    setup(
        name=package_name,
        version="2019.9.29.8.1.45.50215",
        author=__author__,
